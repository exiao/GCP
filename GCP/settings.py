...
DATABASES = {'default': dj_database_url.config(default='sqlite3://tabootstrap.heroku.com')}
...
SECRET_KEY = '$!)_x7l6#tpc!_imc7ku0)hb1d^^_#4@)wj+o6m1x7ditsc!)8'
...
AUTH_PROFILE_MODULE = 'gcpapp.UserProfile'
